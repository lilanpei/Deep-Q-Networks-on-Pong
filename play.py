...
FPS = 25
vis = True
record = '/content/drive/MyDrive/Colab Notebooks/RL/record'
...
if __name__ == "__main__":
    ...
    net = dqN_model2.DQN(env.observation_space.shape, env.action_space.n)
    state = torch.load('/content/drive/MyDrive/Colab Notebooks/RL/PongNoFrameskip-v4-best.dat', map_location=lambda stg,_: stg)
